...
public abstract class Pessoa {
	...
	public static void validateName(String VName) throws InvalidNameException{
		if(VName.trim().isEmpty()){
			throw new InvalidNameException("O nome não pode ser vazio! -> Nome digitado: ", VName);
		}
		else if(VName.trim().length() < 3){
			throw new InvalidNameException("O nome deve ter mais de 3 caracteres! -> Nome digitado: ", VName);
		}
	}
